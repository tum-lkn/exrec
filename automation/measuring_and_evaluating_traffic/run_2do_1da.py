...
from entities import ClockGenerator, Server, PhysicalMachine, Experiment, DemandObliviousController, \
    ListDataCollector, TCPDumpAllToRsCollector, DemandObliviousSwitch, DockerFullLogCollector
...
if __name__ == "__main__":
    ...
    CACHES = [
        ...
        {
            f"{PCI_ADDR_CARD_2}.2": 60001,
        },
        {
            f"{PCI_ADDR_CARD_1}.2": 60002,
        },
        {
            f"{PCI_ADDR_CARD_2}.2": 60002,
        },
        {
            f"{PCI_ADDR_CARD_1}.2": 60001,
        },
    ...
    EXPERIMENT_NAME = f"{MILESTONE_NAME}_2do_1da"
    ...
    for load in [0.3, 0.5, 0.6, 0.7]:
        ...
        myclkgen = ClockGenerator(CLKGEN_PORT, CLK_PERIOD_MILESTONE2, GIT_PATH, USE_PYTHON_CLK,
                                  vmax=VLAN_MAX, duty=0.9)
        ...
        mycachectr = da_controllers.get_staticlist_x8_1da(myservers)
