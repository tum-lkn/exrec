...
from helpers import traffic_inputs, clock_generator
...
if __name__ == "__main__":
    ...
    for clkperiod, model in it.product(
        ...
        myclkgen = ClockGenerator(CLKGEN_PORT, clkperiod, GIT_PATH, USE_PYTHON_CLK,
                                  vmax=VLAN_MAX, duty=DUTY_ML_GPU)
        myrotorctr = DemandObliviousController(GIT_PATH, "static_rules_x4_all_3rotors.py")
