...
if __name__ == "__main__":
    ...
    for clkperiod, model in it.product(
        ...
        myrotorctr = DemandObliviousController(GIT_PATH, "static_rules_x4_all.py")
        ...
        mycachectr = da_controllers.get_staticlist_x4_2da_all_flows(myservers)
